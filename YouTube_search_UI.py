...
videos1 = youtube_search(sentence, 10)
sentence = PP.getSentences()[1]
videos2 = youtube_search(sentence, 10)
...
PP.displayResultsLayout(
    firstSentence=PP.getSentences()[0], 
    secondSentence=PP.getSentences()[1], 
    #firstSnippet=videos[0], 
    #secondSnippet=videos[1], 
    jaccardResult=j_result1, 
    ExjaccardResult=ej_result1,
    wordNetResult=wn_result1,
    wikiSimilarity=wiki_sim)
